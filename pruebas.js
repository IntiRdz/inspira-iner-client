...
import { OBTENER_CAMAS_1 } from '../../graphql/queries'; 

const timeZone = 'America/Mexico_City'; // Define la zona horaria

export default function Clinico1 (){

  const router = useRouter();

  const { data, loading, error } = useQuery(OBTENER_CAMAS_1);
  ...
  const camas = data ? data.obtenerCamas1 : [];
            ...
            {camasOrdenadas.map((cama) => {
              ...
              const ultimaAdmision = ultimoHistorial && ultimoHistorial.admision_relacionada
                ...
                : {};
                  ...
                  // Desestructuración de 'ultimaAdmision'
              ...
              console.log("Paciente Relacioncadla", paciente_relacionado)
                        ...
                        <div 
                            ...
                            style={{ 
                                width: `${
                                    ...
                                    ? (ultimaAdmision.programaintegral.preguntas_contestadas / 12) * 100
                                    : 0
                                }%` 
                            }}
                        >
