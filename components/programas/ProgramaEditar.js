...
/*     fecha_diagnostico: programaintegral.fecha_diagnostico ? format(new Date(programaintegral.fecha_diagnostico), 'yyyy-MM-dd') : '',
    ...
    programa_discapacidad_hipoacusia: programaintegral.programa_discapacidad_hipoacusia ? programaintegral.programa_discapacidad_hipoacusia : '',
    programa_discapacidad_disminucion_visual: programaintegral.programa_discapacidad_disminucion_visual ? programaintegral.programa_discapacidad_disminucion_visual : '',
    programa_discapacidad_perdida_barthel: programaintegral.programa_discapacidad_perdida_barthel ? programaintegral.programa_discapacidad_perdida_barthel : '',
    programa_discapacidad_disminucion_cognitiva: programaintegral.programa_discapacidad_disminucion_cognitiva ? programaintegral.programa_discapacidad_disminucion_cognitiva : '',
    programa_discapacidad_gds_fast: programaintegral.programa_discapacidad_gds_fast ? programaintegral.programa_discapacidad_gds_fast : '',
    programa_discapacidad_nu_desc: programaintegral.programa_discapacidad_nu_desc || '',
    preguntas_contestadas: programaintegral.preguntas_contestadas,
};
