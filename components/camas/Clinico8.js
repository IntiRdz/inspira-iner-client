...
import { OBTENER_CAMAS_8 } from '../../graphql/queries'; 

const timeZone = 'America/Mexico_City'; // Define la zona horaria

export default function Clinico8 (){

  const router = useRouter();

  const { data, loading, error } = useQuery(OBTENER_CAMAS_8);
  ...
  const camas = data ? data.obtenerCamas8 : [];
