...
import { OBTENER_CAMAS_5 } from '../../graphql/queries'; 

const timeZone = 'America/Mexico_City'; // Define la zona horaria

export default function Clinico5 (){

  const router = useRouter();

  const { data, loading, error } = useQuery(OBTENER_CAMAS_5);
  ...
  const camas = data ? data.obtenerCamas5 : [];
