...
import { OBTENER_CAMAS_2 } from '../../graphql/queries'; 

const timeZone = 'America/Mexico_City'; // Define la zona horaria

export default function Clinico2 (){

  const router = useRouter();

  const { data, loading, error } = useQuery(OBTENER_CAMAS_2);
  ...
  const camas = data ? data.obtenerCamas2 : [];
