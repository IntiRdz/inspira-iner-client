...
import { OBTENER_CAMAS_9 } from '../../graphql/queries'; 

const timeZone = 'America/Mexico_City'; // Define la zona horaria

export default function Clinico9 (){

  const router = useRouter();

  const { data, loading, error } = useQuery(OBTENER_CAMAS_9);
  ...
  const camas = data ? data.obtenerCamas9 : [];
