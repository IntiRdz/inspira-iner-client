...
import { OBTENER_CAMAS_7 } from '../../graphql/queries'; 

const timeZone = 'America/Mexico_City'; // Define la zona horaria

export default function Clinico7 (){

  const router = useRouter();

  const { data, loading, error } = useQuery(OBTENER_CAMAS_7);
  ...
  const camas = data ? data.obtenerCamas7 : [];
