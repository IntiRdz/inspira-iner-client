...
import { OBTENER_CAMAS_3 } from '../../graphql/queries'; 

const timeZone = 'America/Mexico_City'; // Define la zona horaria

export default function Clinico3 (){

  const router = useRouter();

  const { data, loading, error } = useQuery(OBTENER_CAMAS_3);
  ...
  const camas = data ? data.obtenerCamas3 : [];
