...
export default function PacienteRenglon2 ({obtenerPaciente, onEdit}) {
        ...
        <table className="table-auto shadow-md mt-2 w-full w-lg">
            ...
            <tr>
                ...
                <td className="border px-1 py-1">
                  {
                    `${obtenerPaciente.pac_nombre} ${obtenerPaciente.pac_apellido_paterno} ${obtenerPaciente.pac_apellido_materno}`
                  }
                </td>
