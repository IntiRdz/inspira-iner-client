        ...
        <table className="table-auto shadow-md mt-1 w-full">
            <thead className="bg-gray-800">
                <tr className="text-white">
                    ...
                    <th className="w-1/7 py-2">Tipo de muestra</th>
                    <th className="w-1/7 py-2">Método de Detección</th>
                    <th className="w-1/7 py-2">Estatus muestra</th>
                    <th className="w-1/7 py-2">Fecha Revisión</th>
                    ...
                    admision.cama_relacionada.flatMap(cama =>
                        cama.microorganismo_relacionado.map((microorganismo, index) => (
                            <tr key={index}>
                                ...
                                <td className="border px-4 py-2">{microorganismo.microorganismo_muestra_tipo}</td>
                                <td className="border px-4 py-2">{microorganismo.metodo_deteccion}</td>
                                <td className="border px-4 py-2">{microorganismo.microorganismo_muestra_resultado}</td>
                                <td className="border px-4 py-2">{microorganismo.fecha_ultima_revision? formatFecha(microorganismo.fecha_ultima_revision, 'dd-MM-yyyy'): ''}</td>
