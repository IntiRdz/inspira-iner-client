...
`;
 ...
 const OBTENER_MICROORGANISMOS_PACIENTE = gql`
  query obtenerMicroorganismosPatient {
      obtenerMicroorganismosPatient {
            id
            fecha_deteccion
            metodo_deteccion
            microorganismo_tipo
...
const NuevoMicroorganismo = () => {
    ...
    const [nuevoMicroorganismo] = useMutation(NUEVO_MICROORGANISMO, {
        update(cache, { data: { nuevoMicroorganismo } }) {
            ...
            const { obtenerMicroorganismosPatient } = cache.readQuery({ query: OBTENER_MICROORGANISMOS_PACIENTE });
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            metodo_deteccion: Yup.string().oneOf([
                'PCR', 
                'Panel', 
                'Cultivo'
            ]).required('El método de detección es obligatorio'),
            microorganismo_tipo: Yup.string().oneOf([
                'Virus', 
                'Bacteria', 
                'Micobacteria', 
                'Hongo'
        ...
        onSubmit: async valores => {
            ...
            try {
                ...
                Swal.fire(
                    'Creado',
                    'Se ingresó y asoció el microorganismo correctamente',
                    'success'
                )
                    ...
                    >
                        ...
                        <div className="mb-4">
                            ...
                            >
                                ...
                                <option value="Cultivo" label="No Cultivo" />
                            </select>
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <select 
                                ...
                                onChange={formik.handleChange}
                                onBlur={formik.handleBlur}
                                value={formik.values.microorganismo_genero}
                            >
                                <option value="" label="Seleccione una opción" />
