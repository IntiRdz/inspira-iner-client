    ...
    return ( 
        ...
        <Layout>
            ...
            <tbody className="bg-white">
                ...
                <td className="border px-1 py-1">{obtenerPaciente.pac_genero}</td>
                <td className="border px-1 py-1">{obtenerPaciente.pac_dispositivo_o2}</td>
                <td className="border px-1 py-1">{obtenerPaciente.pac_hemodialisis}</td>
                <td className="border px-1 py-1">{obtenerPaciente.caracteristicas_especiales}</td>
                <td className="border px-1 py-1">{obtenerPaciente.pac_codigo_uveh || []}</td>
                ...
                <td className="border px-1 py-1">microorganismo</td>
